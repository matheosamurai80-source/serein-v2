  ...
  return (
    <LegalPage title="Mentions légales" updated="5 juillet 2026">
      ...
      <p>
        ...
        Il n&apos;exécute <strong>aucune démarche</strong> à la place de l&apos;utilisateur, ne perçoit
        aucune commission d&apos;aucun fournisseur, et ne fournit ni conseil en assurance ni
        intermédiation au sens du Code des assurances — c&apos;est toujours l&apos;utilisateur qui décide
        et qui agit. Les tarifs d&apos;offres tierces affichés sont indicatifs et à vérifier auprès
