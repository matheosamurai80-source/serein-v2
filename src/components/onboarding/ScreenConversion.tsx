  ...
  return (
    <div className="flex flex-col items-center w-full animate-fade-up">
      ...
      <h2 className="font-serif text-[clamp(24px,5.5vw,44px)] tracking-[-0.025em] leading-[1.15] text-warm mb-2 text-center">
        Serein veille.<br /><em className="text-sage-light">Vous décidez.</em>
      </h2>
      <p className="text-[clamp(15px,3.5vw,17px)] text-white/65 font-light mb-6">
      ...
      <a
        ...
        className="w-full bg-sage text-night-2 rounded-[18px] p-5 flex items-center gap-4 text-left hover:bg-sage-light transition-all mb-3"
      >
        <div className="w-11 h-11 rounded-xl bg-night-2/15 flex items-center justify-center text-xl flex-shrink-0">📋</div>
      ...
      <div className="flex flex-col gap-3 w-full mb-4">
        <button
          ...
          className="w-full bg-white/3 border-2 border-white/7 rounded-[18px] p-5 flex items-center gap-4 text-left opacity-70 hover:opacity-100 transition-all"
        >
          <div className="w-11 h-11 rounded-xl bg-sage/12 flex items-center justify-center text-xl flex-shrink-0">🏦</div>
          <div className="flex-1">
            <p className="text-sm font-semibold text-warm mb-0.5">Connexion bancaire</p>
            <p className="text-xs text-white/38 leading-[1.5]">Détection automatique de vos abonnements</p>
          </div>
          <span className="font-mono text-[10px] tracking-wider uppercase px-2.5 py-1 rounded-full bg-amber/15 text-amber-light flex-shrink-0">
            Bientôt
          </span>
        </button>
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-warm mb-0.5">Import de relevé PDF</p>
            <p className="text-xs text-white/38 leading-[1.5]">Analyse automatique de vos prélèvements</p>
          </div>
          <span className="font-mono text-[10px] tracking-wider uppercase px-2.5 py-1 rounded-full bg-amber/15 text-amber-light flex-shrink-0">
            Bientôt
          </span>
